...
public interface SecretaryBeanLocal {
    ...
    boolean registerStudentPayment(int studentID, int registerID, String description, String value, int secretaryID);
    ...
    boolean registerPersonalAnnouncement(int studentID, String title, String description);
