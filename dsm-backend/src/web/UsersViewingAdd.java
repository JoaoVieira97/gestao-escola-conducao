...
@WebServlet(name = "UsersViewingAdd", urlPatterns = {"/api/lessons/add/viewing"})
public class UsersViewingAdd extends HttpServlet {

    private final static Logger log = Logger.getLogger(UsersViewingAdd.class.getName());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(accessToken != null && DSMFacade.isTokenValid(accessToken)) {
            ...
            boolean success = DSMFacade.addUsersViewing(instructorID, datetime);
            if(success) {
