...
public class DSMPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "DSM";
	...
	private DSMPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new DSMPersistentManager();
		}
