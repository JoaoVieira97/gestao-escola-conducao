...
CREATE TABLE WorkingDay (ID int(10) NOT NULL AUTO_INCREMENT, Name varchar(255), PRIMARY KEY (ID));
CREATE TABLE SchoolInfo (ID int(10) NOT NULL AUTO_INCREMENT, MaxTimeToCancel time NOT NULL, StartTime time NOT NULL, EndTime time NOT NULL, PRIMARY KEY (ID));
...
CREATE TABLE Register (ID int(10) NOT NULL AUTO_INCREMENT, InstructorUserID int(10) NOT NULL, CategoryID int(10) NOT NULL, StudentUserID int(10) NOT NULL, InitialDate date, PRIMARY KEY (ID));
CREATE TABLE Announcement (ID int(10) NOT NULL AUTO_INCREMENT, Title varchar(255), Description varchar(255), Timestamp timestamp NULL, PRIMARY KEY (ID));
CREATE TABLE Exam (ID int(10) NOT NULL AUTO_INCREMENT, StudentUserID int(10) NOT NULL, StartTime timestamp NULL, Description varchar(255), PRIMARY KEY (ID));
CREATE TABLE Payment (ID int(10) NOT NULL AUTO_INCREMENT, RegisterID int(10) NOT NULL, SecretaryUserID int(10) NOT NULL, Value double NOT NULL, Timestamp date, Description varchar(255), PRIMARY KEY (ID));
CREATE TABLE Secretary (UserID int(10) NOT NULL, PRIMARY KEY (UserID));
CREATE TABLE Category (ID int(10) NOT NULL AUTO_INCREMENT, Name varchar(255), PracticalLessons int(10) NOT NULL, TheoreticalLessons int(10) NOT NULL, Price float NOT NULL, PRIMARY KEY (ID));
...
CREATE TABLE `User` (ID int(10) NOT NULL AUTO_INCREMENT, Name varchar(255), Email varchar(255), Password varchar(255), Role varchar(255), PRIMARY KEY (ID));
...
CREATE TABLE Theme (ID int(10) NOT NULL AUTO_INCREMENT, Name varchar(255), PRIMARY KEY (ID));
CREATE TABLE Lesson (ID int(10) NOT NULL AUTO_INCREMENT, InstructorUserID int(10) NOT NULL, StartTime timestamp NULL, Duration int(10) NOT NULL, State varchar(255), PRIMARY KEY (ID));
