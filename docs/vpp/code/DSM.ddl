...
CREATE TABLE Register (ID int(10) NOT NULL, InstructorUserID int(10) NOT NULL, LicenseCarID int(10) NOT NULL, StudentUserID int(10) NOT NULL, InitialDate date, PRIMARY KEY (ID));
...
CREATE TABLE Payment (ID int(10) NOT NULL, SecretaryUserID int(10) NOT NULL, LicenseCarID int(10) NOT NULL, StudentUserID int(10) NOT NULL, Value double NOT NULL, Timestamp date, PRIMARY KEY (ID));
CREATE TABLE Secretary (UserID int(10) NOT NULL, PRIMARY KEY (UserID));
CREATE TABLE LicenseCar (ID int(10) NOT NULL, PracticalLessons int(10) NOT NULL, TheoreticalLessons int(10) NOT NULL, Name varchar(255), PRIMARY KEY (ID));
...
CREATE TABLE `User` (ID int(10) NOT NULL, FirstName varchar(255), LastName varchar(255), Email varchar(255), Password varchar(255), Role varchar(255), PRIMARY KEY (ID));
...
CREATE TABLE Lesson_LicenseCar (LessonID int(10) NOT NULL, LicenseCarID int(10) NOT NULL, PRIMARY KEY (LessonID, LicenseCarID));
...
ALTER TABLE Payment ADD CONSTRAINT FKPayment681118 FOREIGN KEY (StudentUserID) REFERENCES Student (UserID);
ALTER TABLE Exam ADD CONSTRAINT FKExam479921 FOREIGN KEY (StudentUserID) REFERENCES Student (UserID);
ALTER TABLE Announcement ADD CONSTRAINT FKAnnounceme551434 FOREIGN KEY (StudentUserID) REFERENCES Student (UserID);
...
ALTER TABLE Payment ADD CONSTRAINT FKPayment214325 FOREIGN KEY (LicenseCarID) REFERENCES LicenseCar (ID);
ALTER TABLE Lesson_LicenseCar ADD CONSTRAINT FKLesson_Lic284559 FOREIGN KEY (LessonID) REFERENCES Lesson (ID);
ALTER TABLE Lesson_LicenseCar ADD CONSTRAINT FKLesson_Lic703619 FOREIGN KEY (LicenseCarID) REFERENCES LicenseCar (ID);
...
ALTER TABLE Register ADD CONSTRAINT FKRegister214735 FOREIGN KEY (LicenseCarID) REFERENCES LicenseCar (ID);
